...
export function loadSettings(): AppSettings {
  try {
    ...
    if (!raw) return { calibrationEnabled: false, soundOnRep: true, soundOnGoal: true, voiceCoachEnabled: true };
    ...
    return {
      ...
      voiceCoachEnabled: parsed.voiceCoachEnabled !== undefined ? Boolean(parsed.voiceCoachEnabled) : true,
    };
  } catch {
    return { calibrationEnabled: false, soundOnRep: true, soundOnGoal: true, voiceCoachEnabled: true };
  }
}
